...
\begin{document}
    ...
    \noindent
    The use cases identified are 5:
    \begin{itemize}
        \item \textbf{Research Trip}

        \item \textbf{Add Constraints}

        \item \textbf{Show Public Transport Occupancy}

        \item \textbf{Show Public Transit Timetables}

        \item \textbf{Show Bike/Ride Sharing}
    \end{itemize}
